...
private: 
  ...
  jsk_recognition_msgs::BoundingBox jsk_bbox_transform(const obsdet_msgs::DetectedObject &autoware_bbox,
                                                       const std_msgs::Header &header, const geometry_msgs::Pose &pose_transformed);

  void MainLoop(const obsdet_msgs::CloudClusterArray::ConstPtr &input_msg);
  void calculateDimPos(const pcl::PointCloud<pcl::PointXYZ> &cluster, obsdet_msgs::DetectedObject &output, double &theta_star);
...
LShapeFittingNode::LShapeFittingNode() : nh_(""), private_nh("~"),tf2_listener(tf2_buffer)
{
  ...
  pub_autoware_object_ = nh_.advertise<obsdet_msgs::DetectedObjectArray>(L_shape_output_, 1, true);
...
void LShapeFittingNode::MainLoop(const obsdet_msgs::CloudClusterArray::ConstPtr& input_msg)
{
  ...
  for (auto &cluster_ : output_msg.clusters)
  {
    ...
    obsdet_msgs::DetectedObject object;
    double theta_optim;
...
void LShapeFittingNode::calculateDimPos(const pcl::PointCloud<pcl::PointXYZ>& cluster, obsdet_msgs::DetectedObject& output, double &theta_star)
{
...
jsk_recognition_msgs::BoundingBox LShapeFittingNode::jsk_bbox_transform(const obsdet_msgs::DetectedObject &autoware_bbox, 
          const std_msgs::Header& header, const geometry_msgs::Pose& pose_transformed)
{
  jsk_recognition_msgs::BoundingBox jsk_bbox;
